...
if __name__ == '__main__':
    DClasses = ["zho",  "tel",  "ara", "spa", "hin", "fra","jpn"]
    ...
    base = "raw/test/"
    with open('naivebayes-raw_result.txt','w') as f:
        for lang in DClasses:
            ...
            for lang in prob_per_lang:
                print('{0}: {1:3}/{2:3} {3:>.5%}'.format(lang,prob_per_lang[lang],num_files,(prob_per_lang[lang]/num_files)),file=f)
